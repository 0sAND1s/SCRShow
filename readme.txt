...
The SCREEN$ files are used from the 'scr' folder, so images can be replaced. The fie names must be numeric, from 1 to 100.
...
There is a message shown on screen after each image in the format <file number>:<pause in seconds>.
